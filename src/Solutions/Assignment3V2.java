 ...
 * The program will calculate the sum of the even numbers of the correct sequence and the sum of the odd numbers and will 
 * print both on the screen after all the numbers of the sequence have been read.
 */
package assignment3;
...
public class Assignment3V2 {
	...
	public static void main(String[] args) {
		...
		int n, // number of integers for the sequence
		    ...
		    evenSum = 0, oddSum = 0; // sum of numbers in even positions and odd positions in the sequence
		...
		System.out.println("The sum of numbers in even positions is " + evenSum+ " and the sum of numbers in odd positions is " + oddSum);
		System.out.println("\nEnd of the program...");
	}// end of main
}// end of program