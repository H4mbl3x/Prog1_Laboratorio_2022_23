...
public class Session4Exercise2 {

	private static final Scanner KEYB = new Scanner(System.in);

	public static void main(String[] args) {
		int sequenceNumber, evenNumber, oddNumber, loopNumber, integer, odd = 0, even = 0, errors = 0;
		...
		evenNumber = sequenceNumber / 2;
		oddNumber = sequenceNumber / 2;
		...
		int[] evenVector = new int[evenNumber];
		int[] oddVector = new int[oddNumber];
		if (integer % 2 == 0) {
			evenVector[0] = integer;
		} else {
			oddVector[0] = integer;
		}
		for (loopNumber = 1; loopNumber < sequenceVector.length; loopNumber++) {
			if (integer % 2 == 0) {
				...
				oddVector[loopNumber / 2] = integer;
				...
				even = even + integer;
				sequenceVector[loopNumber] = integer;
				evenVector[loopNumber / 2] = integer;
			}
		...
		System.out.println("The vector of even numbers is:");
		for (loopNumber = 0; loopNumber < evenVector.length; loopNumber++)
			System.out.print(" " + evenVector[loopNumber]);
		System.out.println("\nThe vector of odd numbers is:");
		for (loopNumber = 0; loopNumber < oddVector.length; loopNumber++)
			System.out.print(" " + oddVector[loopNumber]);
	}
